...
### Requirement: Basic allowance is configurable
The system SHALL default the salaries-tax basic allowance to HKD 132,000 and
SHALL allow overriding it via a `tax.basic_allowance` field in the scenario
file.

#### Scenario: Override applied
- **WHEN** the scenario sets `tax: { basic_allowance: 145000 }` and a block
  accrues HKD 320,000 gross (MPF 18,000)
- **THEN** net chargeable income is 157,000 (not 170,000) and the tax charge
  reflects that
